...
class WayPointFollower(Node):
    ...
    def __init__(self):
        ...
        self._action_client = ActionClient(self, FollowWaypoints, '/follow_waypoints')#estoooooooooooooooooooooooooooo
        #18 movement_server



    #definimos la funcion de mandar goal
    def send_goal(self, poses):#estoooooooooooooooooooooooooooo
...
#estoooooooooooooooooooooooooooo
